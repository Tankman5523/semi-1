...
/**
 * Servlet implementation class AccidentBoardEnrollController
 */
@WebServlet("/enroll.ac")
public class AccidentEnrollFormController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AccidentEnrollFormController() {
        super();
					...
					if(result>0) {
						...
						if(multiRequest.getOriginalFileName("video")!=null) {
							...
							if(result==0) { //파일 db에 등록 실패
								...
								request.getRequestDispatcher(request.getContextPath()+"/list.ac?currentPage=1").forward(request, response);
