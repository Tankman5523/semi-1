...
public class ManagerDeleteMemberController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Member> deleteMemList = new ManagerService().selectDeleteMember();

		request.setAttribute("deleteMemList", deleteMemList);
		request.getRequestDispatcher("views/manager/manager_DeleteMemberList.jsp").forward(request, response);
