...
/**
 * Servlet implementation class QuestionBoardListController
 */
@WebServlet("/list.qa")
public class QuestionBoardListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuestionBoardListController() {
        super();
