...
<div id="content">
	...
	<div id="search-area">
		<form id="search-form" action="<%=contextPath%>/list.la" method="post">
			<div id="searchName">
				<span>변호사이름</span> <input type="search" id="name" name="nameKey" placeholder="변호사 이름 입력">
			</div>
			<div>
				<span>분야별</span> <select name="cateKey" id="category">
	...
	<div id="list-area">
		...
		<div id="manual-area">
			<div id="manualbar">
				<br><br> <b style="color: black">이용방법</b><br>
				<br> 1. 상담신청서 작성<br>
				<br> 2. 온라인 상담받기<br>
				<br> 3. 방문/전화 상담받기<br><br>
			</div>
		</div>
	</div>

	<script>
    	$("#lawList>div").click(function(){ //변호사 상세페이지로 이동
