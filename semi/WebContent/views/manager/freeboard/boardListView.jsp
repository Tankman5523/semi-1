	...
	<%@include file="../manager_header.jsp"%>
		...
		<div id="content">
        	...
        	<div class="sort_area" align="center" style="height: 10%;">
				<button type="button" class="btn btn-light" name="sort" value="liked">추천수</button>
				<button type="button" class="btn btn-light" name="sort" value="report">비추천수</button>
				<button type="button" class="btn btn-light" name="sort" value="count">조회수</button>
				<button type="button" class="btn btn-light" name="sort" value="reply">댓글수</button>
			</div>
